...
WEB_APP_HOST="${WEB_APP_HOST:-$TRAFFIC_HOST}"
WEB_APP_PORT="${WEB_APP_PORT:-8443}"
WEB_APP_URL="https://${WEB_APP_HOST}:${WEB_APP_PORT}"
SSH_HOST="${SSH_HOST:-$TRAFFIC_HOST}"
SSH_PORT="${SSH_PORT:-2222}"
SSH_USER="cbomuser"
SSH_PASS="cbom_demo_2024!"
DB_HOST="${DB_HOST:-$TRAFFIC_HOST}"
